  ...
  function buildReportHtml(report,mode,period,range){
    ...
    return '<!doctype html><html lang="ru"><head><meta charset="utf-8">'+
      ...
      'const qPokoyPdfFileName='+JSON.stringify(pdfFileName)+';'+
        ...
        'const root=document.createElement("div");root.className="pdf-export-root";document.body.appendChild(root);'+
        'let pageNumber=0;'+
        'function createPage(first){'+
          'pageNumber+=1;'+
          'const page=document.createElement("section");page.className="pdf-page";'+
          'const content=document.createElement("div");content.className="pdf-page-content";page.appendChild(content);'+
          ...
          'const table=document.createElement("table");table.className="income-table pdf-page-table";'+
          ...
          'const footer=document.createElement("div");footer.className="pdf-page-number";footer.textContent=String(pageNumber);page.appendChild(footer);'+
