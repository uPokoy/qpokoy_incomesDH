(function qPokoyReportPrintInit(){
  ...
  function buildReportHtml(report,mode){
    ...
    return '<!doctype html><html lang="ru"><head><meta charset="utf-8">'+
      ...
      'body{padding:22px;max-width:920px;margin:0 auto}.report-head{display:flex;justify-content:space-between;align-items:flex-start;gap:24px;margin-bottom:18px}.report-head h1{margin:0 0 3px;font-size:20px;line-height:1.15}.period{font-size:13px;color:#374151}.report-meta{text-align:right;color:#6b7280;font-size:11px;line-height:1.5;white-space:nowrap}.summary{display:grid;grid-template-columns:1.45fr .8fr .8fr;margin:0 0 18px;background:#f5f7fa;border:1px solid #edf0f3;border-radius:9px;overflow:hidden}.metric{min-height:70px;padding:12px 15px;display:flex;flex-direction:column;justify-content:center}.metric+.metric{border-left:1px solid #dde2e8}.metric strong{font-size:23px;line-height:1;font-weight:750;letter-spacing:-.02em}.metric:not(:first-child) strong{font-size:20px}.metric span{margin-top:5px;color:#6b7280;font-size:11px}.income-table{width:100%;border-collapse:separate;border-spacing:0;border:1px solid #e5e7eb;border-radius:8px;overflow:hidden}thead{display:table-header-group}th{background:#f3f4f6;color:#4b5563;font-size:11px;font-weight:650;text-align:left}th,td{padding:8px 9px;border-bottom:1px solid #e5e7eb;vertical-align:top}tbody tr:last-child td{border-bottom:0}.date{width:18%;white-space:nowrap}.category{width:22%}.description{width:40%;word-break:break-word}.number{width:20%;text-align:right;white-space:nowrap;font-weight:650}.total-row td{background:#f8fafc;font-weight:750;border-top:1px solid #dbe1e7}.total-row .number{font-size:14px}.report-actions{position:fixed;right:20px;bottom:20px}.report-actions button{padding:11px 15px;border:0;border-radius:9px;background:#2563eb;color:#fff;font:600 13px inherit;cursor:pointer;box-shadow:0 8px 24px rgba(37,99,235,.22)}tr{break-inside:avoid;page-break-inside:avoid}@media print{body{padding:0;max-width:none}.report-actions{display:none}.summary{break-inside:avoid;page-break-inside:avoid}.income-table{border-radius:6px}*{-webkit-print-color-adjust:exact;print-color-adjust:exact}}'+
      '</style></head><body>'+
      '<header class="report-head"><div><h1>Отчёт о доходах</h1><div class="period">'+escapeHtml(report.label)+'</div></div><div class="report-meta">'+escapeHtml(range)+'<br>Сформировано '+escapeHtml(generated)+'</div></header>'+
