(function qPokoyReportPrintInit(){
  ...
  function buildReportHtml(report,mode){
    ...
    return '<!doctype html><html lang="ru"><head><meta charset="utf-8">'+
      ...
      incomeRows(records)+
      '<tr class="total-row"><td colspan="3"></td><td class="number total-inline"><span>Итого:</span><strong>'+escapeHtml(money(total))+'</strong></td></tr>'+
      '</tbody></table>'+
