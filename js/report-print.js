  ...
  function buildReportHtml(report,mode,period,range){
    ...
    return '<!doctype html><html lang="ru"><head><meta charset="utf-8">'+
      ...
      'const qPokoyPdfFileName='+JSON.stringify(pdfFileName)+';'+
        ...
        'const options={margin:[13,12,13,12],filename:qPokoyPdfFileName,image:{type:"jpeg",quality:.98},html2canvas:{scale:2,useCORS:true,backgroundColor:"#ffffff",logging:false,onclone:function(doc){const cloned=doc.getElementById("reportDocument");if(cloned)cloned.classList.add("pdf-export");}},jsPDF:{unit:"mm",format:"a4",orientation:"portrait"},pagebreak:{mode:["css","legacy"],avoid:["tr",".summary"]}};'+
