...
(function(){
  ...
  function installStyles(){
    ...
    style.textContent=`
      ...
      .qp-background-custom-wrap>.qp-background-help{position:absolute;z-index:6;left:calc(100% + 8px);top:50%;transform:translateY(-50%);}
      ...
      .qp-background-remove{position:absolute !important;left:calc(50% + 30px);top:50%;transform:translateY(-50%) !important;width:22px !important;min-width:22px !important;height:22px !important;padding:0 !important;border:0 !important;border-radius:0 !important;background:transparent !important;box-shadow:none !important;outline:none !important;color:rgba(239,68,68,.72) !important;font-family:inherit !important;font-size:19px !important;font-weight:500 !important;line-height:1 !important;cursor:pointer !important;pointer-events:auto !important;-webkit-tap-highlight-color:transparent !important;}
      .qp-background-remove:hover,
      .qp-background-remove:active,
      ...
      @media (max-width:700px){
        ...
        .qp-background-custom-wrap>.qp-background-help{left:auto;right:-26px;}
        ...
        .qp-background-remove:active,
        .qp-background-remove:focus,
        .qp-background-remove:focus-visible{left:calc(50% + 25px) !important;}
