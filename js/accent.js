...
(function(){
  ...
  function installStyles(){
    ...
    style.textContent=`
      ...
      .qp-background-remove{position:absolute;z-index:3;top:4px;right:4px;width:38px;height:38px;padding:0;display:grid;place-items:center;border:0;background:transparent;color:#ff2f35;box-shadow:none;cursor:pointer;font-size:38px;font-weight:900;line-height:1;text-shadow:-1px -1px 0 #ffffff,1px -1px 0 #ffffff,-1px 1px 0 #ffffff,1px 1px 0 #ffffff,0 2px 5px rgba(0,0,0,.95);}
      .qp-background-remove:hover{background:transparent;color:#ff171f;transform:scale(1.08);}
      ...
      @media (max-width:700px){
        ...
        .qp-background-remove{top:2px;right:2px;width:34px;height:34px;font-size:34px;}
